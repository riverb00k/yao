...
import com.websarva.wings.android.yao.databinding.FragmentItemListDialogListDialogBinding
...
class ItemListDialogFragment : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        activity?.findViewById<RecyclerView>(R.id.kusurieturannlistview)?.layoutManager =
            LinearLayoutManager(context)
        activity?.findViewById<RecyclerView>(R.id.kusurieturannlistview)?.adapter =
            arguments?.getInt(ARG_ITEM_COUNT)?.let { ItemAdapter(it) }
    }

    private inner class ViewHolder internal constructor(binding: FragmentItemListDialogListDialogBinding) :
    ...
    private inner class ItemAdapter internal constructor(private val mItemCount: Int) :
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            ...
            return ViewHolder(
                FragmentItemListDialogListDialogBinding.inflate(
                    LayoutInflater.from(
                        parent.context
                    ), parent, false
                )
